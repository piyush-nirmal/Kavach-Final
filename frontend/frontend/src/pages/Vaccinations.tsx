...
import { Syringe, CheckCircle2, Clock, Plus, Calendar, MapPin, User, Loader2 } from 'lucide-react';
  ...
  if (!child && !loading) {
    return (
      <div className="p-8 text-center">
        <p className="text-muted-foreground">No children registered yet. Please register a child first.</p>
      </div>
    );
  }
